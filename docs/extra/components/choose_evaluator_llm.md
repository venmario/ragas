...
=== "Others"
    ...
    If you're still not able to use Ragas with your favorite LLM provider, please let us know by commenting on this [issue](https://github.com/vibrantlabsai/ragas/issues/1617) and we'll add support for it 🙂.